	...
	return (
		<Fragment>
			<div className="bg-background text-foreground flex flex-col min-h-[80svh] max-w-6xl mx-auto justify-center items-center px-4 sm:px-6 text-center">
				...
				<p className="mt-4 sm:mt-4 text-sm sm:text-base md:text-lg text-muted-foreground max-w-lg sm:max-w-2xl">
					Clouly lets you create and manage subdomains under{" "}
					<strong className="font-semibold">clouly.in</strong> - a
					fast, secure, and developer-friendly way to keep all your
